          ...
          <div className="p-8 text-center space-y-6">
             <div>
                <h2 className="text-xl font-bold text-slate-800 mb-2">
                   {isResume ? "Welcome Back!" : "AI Smart Study"}
                </h2>
                <p className="text-slate-500 text-sm leading-relaxed">
                   AI ke saath padhai kare smart tarike se. Book jaisa faltu kahaniyo se bache, AI tumko bas jaruri topics hi dega!
                </p>
             </div>
             ...
             <div className="pt-4 border-t border-slate-100">
                <p className="text-[10px] font-black uppercase tracking-wider mb-1 bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent animate-pulse">Developed by Nadim Anwar</p>
